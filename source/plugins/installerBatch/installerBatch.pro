...
QMAKE_POST_LINK += pyuic4 -x $$PWD/downloadselection.ui -o $$PWD/downloadselection.py $$escape_expand(\\n)
...
QMAKE_POST_LINK += xcopy /y /s /I $$WINPWD\\downloadselection.py $$quote($$DSTDIR)\\plugins\\data\\ $$escape_expand(\\n)
